...
wbm_sim_folder = Path("D:/projects/CPS-SenarioGeneration/data/iptlc/MonteCarlo/2024-05-09_15-16-30/")
...
gbm_1_sim_folder = Path("data/gbm-simulations/iptlc/arch_1-0_0_1/2024-05-09_15-16-30")
...
# %% Architecture 2
gbm_2_sim_folder = Path("data/gbm-simulations/iptlc/arch_2-1_0_0/2024-05-09_15-16-30")
...
# %% Full BBM
full_bbm_sim_folder = Path("data/gbm-simulations/iptlc/arch_3-1_0_1/2024-05-09_15-16-30")
...
for sim_data, name in zip(sim_data_list, names_list):
    ...
    if name == "WBM":
        for i in range(n):
            ax[i].plot(x[:, i], label=name, alpha=1, color="black")
    else:
        for i in range(n):
            ax[i].plot(x[:, i], label=name, alpha=0.5)
