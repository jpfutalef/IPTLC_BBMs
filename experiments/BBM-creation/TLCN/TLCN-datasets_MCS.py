...
output_folder = Path(f"data/IO-datasets/TLCN/MCS_data/{dataset_id}")
os.makedirs(output_folder, exist_ok=True)

# Open plant
plant_path = sim_folder / "plant.pkl"

#%% Info.txt file
info_file = Path(output_folder, "info.txt")
str_info = f"""Dataset for the TLCN created from the Monte Carlo simulations.
    - Plant: {plant_path}
